...
- Type notes marked with `ontologize: true`, with `up` mirroring their inheritance chain for Breadcrumbs-style navigation.
...
- Entity notes that use `is-instance`, `up`, `lock`, properties, and relations.
